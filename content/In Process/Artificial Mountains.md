...
publish: true
created: 2026-01-27
modified: 2026-06-30T13:50:36.953-07:00
tags:
  - 🙂Agree
  - 🟢Conviction
  - 📝Essay
...
Interestingly, Genesis 2:20 starts in a very different place. It speaks of the first use of human tooling not as an external implement, but an internal naming. Adam is invited to help shape the world by performing the core work of categorization and language formation.

Additionally, if we reach back to the Greek root _tekhnē_ meaning "art, skill, craft in work," we see this same connection between the root and our modern word Technology. This helps us see the line to be drawn between our internal tools or tekhne (sometimes referred to as "Ancient Technologies") such as categorization, language, memory, logic, and storytelling and how they reach out into external technologies in everyday life. Yet whether we speak of inner tekhne or outer technology both proceed from the tools that are deeply embedded and formed within us as simple gifts from God.
...
Much more can be said about these most ancient technologies dwelling with in us. Especially how our ability to categorize accurately became corrupted when Adam and Eve stole knowledge and "control" of God's categories of Good and Evil. Or how language was splintered by the idolatry of Babel's tower.
...
Therefore, we should encounter and use our internal and external tooling within this tension. It is in the separation of technology from God that human pride begins to run amok.
...
1. All technology both external (pluming, books, etc.) and internal (logic, memory, etc.) are gracious gifts from God to ease the suffering of sin and provide for our needs (Think 4th petition of the Lord's Prayer).
2. However, technology is not neutral. It always originates and flows out of our internal tooling and is embedded as firmly as we are in a broken and sinful world. This is seen in the very necessity and design of our technologies. Their shape and structure are derived to solve issues, or create advantages, only necessary in a fallen world.  For example, the fact that we need the word of God written down is a testament to just how broken our memory really is.
...
The human dream seems to start innocently enough. An idea is carried by language into a set of physical technologies:  "'Come, let us make bricks, and burn them thoroughly.' And they had brick for stone, and bitumen for mortar."- Gen 11: 3

Sounds a lot like the techno-hype we live in today. “Hey look at this new shiny tool! The world will never be the same!”

While claims like this may be true, and the potential for a technology may indeed be exciting, apart from God their use seems to always lead to a false hope for human utopia:
...
On a first read this technological dream seems mundane enough but in it we see the echos of all human pride that has followed throughout history.
This is a dream to conquer heaven with a tower and control humans with a city and reputation.

In fact the tower is far worse than we may realize at first. To reach up to heaven on their own means that the architects of Babel set out to construct a human and artificial version of the high place of God. The same kind of high place promised to be built by God's hand - not humanity's:
...
Throughout Scripture mountains and high places were where God is encountered and met (see my essay [[Mountains of Scripture]] for a full list) but humans have always had the problem of trying to force these high places and use them according to our human will and sinful desires.

In other words, they were making an artificial mountain. An attempt to reorient their society not around the mountain of God, or His dwelling, but a human built center of gravity. This ends up being an attempt at their own artificial garden of Eden coming about because of technology.

It was an artificial mountain on the plain, rather than the a real mountain in a range. From the false holy place, they planned to gather people together around their human accomplishments.
...
But that dark human dream has never really gone away. The Israelites made all kinds of false high places. And chased after the “advancements”  of the nations all around them (a new Assyrian style altar anyone?).

The core technology that God disrupts is not the external one but the internal one:
...
1. Use any technology to “free” ourselves from God.
2. Hope to “save” humanity by technological means (be that internal or external tooling).
...
Later in the same exact country Pharaoh uses bricks for his own power and pride. Building vast cities and monuments. He also uses extensive slave labor to employ the brick.

How we use technology and for what ends makes a difference.
