...
> With the rise of AI and the deterioration of search engines (i.e. you can pay enough to be the first result), preserving knowledge that can not be easily accessed because it is not in the main distribution  (i.e. [[Learning and the Inner Life/Technology and Tools/Tail Knowledge and Knowledge Collapse]]) will be increasingly important. Because, realistically, good solid theology will most likely find itself in the tail. Being less accessed and more easily forgotten and pushed aside.
