...
A key point he made about the difference between this kind of experiential learning and the learning he received in a classroom was that learning on his own was [[The Garden/Memory and Learning/Learning and the Inner Life/Rhythms and Practices/Failure Based Learning]]. The feedback loop of being allowed to fail and learning from that failure was what actually empowered him to keep trying until he succeeded. While learning in a classroom is mostly [[The Garden/Memory and Learning/Learning and the Inner Life/Rhythms and Practices/Success Based Learning]] and left him feeling defeated when unable to perform a task or learn something the way he was expected.
...
- Natural learning loops in the environment around us. 
	- Learning should be built into the environment around us. Like the [[The Garden/Doctrine and Logic/Liturgy and Sacred Space/Pedagogy of Space]]. The feedback loop is more effecting the more natural it is.

- How could [[The Wilderness/Digital Gardening]] be used as a way to help teach with an intentional feedback loop? One possibility could be to start students with an empty garden and then have a full one when they finish a class or session. Each week or class period then they would be tasked with tending their garden. 